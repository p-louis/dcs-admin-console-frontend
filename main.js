...
var $author$project$Main$GotUserResult = function (a) {
	return {$: 'GotUserResult', a: a};
};
...
var $author$project$Pages$Login$init = function (session) {
	var model = {password: '', session: session, username: ''};
	if (session.$ === 'Guest') {
...
var $author$project$Api$Endpoint$request = function (config) {
	var _v0 = config.withCredentials;
	if (_v0) {
...
var $author$project$Api$getSecure = F4(
	function (user, url, toMsg, decoder) {
...
var $author$project$Api$Endpoint$tacview = A2(
	$author$project$Api$Endpoint$url,
	_List_fromArray(
		['admin', 'tacview']),
	_List_Nil);
var $author$project$Pages$Upload$refreshTacViews = function (session) {
	return A4(
		$author$project$Api$getSecure,
		$author$project$Pages$Upload$sessUser(session),
		$author$project$Api$Endpoint$tacview,
		$author$project$Pages$Upload$GotTacViewResult,
		$elm$json$Json$Decode$list($author$project$Pages$Upload$filenameDecoder));
};
...
var $author$project$Api$delete = F4(
	function (url, toMsg, body, decoder) {
		return $author$project$Api$Endpoint$request(
			{
				body: body,
				expect: A2($elm$http$Http$expectJson, toMsg, decoder),
...
var $author$project$Api$Endpoint$login = A2(
	...
	_List_fromArray(
		['login']),
	_List_Nil);
var $author$project$User$User = function (token) {
	return {token: token};
};
...
var $author$project$Session$logout = function (msg) {
	return A4($author$project$Api$delete, $author$project$Api$Endpoint$login, msg, $elm$http$Http$emptyBody, $author$project$User$tokenDecoder);
};
...
var $author$project$Main$toSession = function (model) {
	switch (model.$) {
		...
		case 'Redirect':
			...
			return session;
		case 'Login':
			var loginMdl = model.a;
			return loginMdl.session;
		case 'Logout':
			var session = model.a;
			return session;
		default:
			var uploadModel = model.a;
...
var $author$project$Main$changeRouteTo = F2(
	function (route, model) {
		...
		var _v0 = _Utils_Tuple2(route, session);
		_v0$7:
		while (true) {
			if (_v0.a.$ === 'Just') {
				switch (_v0.a.a.$) {
					...
					case 'Login':
						var _v6 = _v0.a.a;
						var _v7 = $author$project$Pages$Login$init(session);
						var loginMdl = _v7.a;
						var loginCmd = _v7.b;
						return _Utils_Tuple2(
							$author$project$Main$Login(loginMdl),
							A2($elm$core$Platform$Cmd$map, $author$project$Main$GotLoginMsg, loginCmd));
					case 'Upload':
						if (_v0.b.$ === 'LoggedIn') {
							var _v8 = _v0.a.a;
							var _v9 = _v0.b;
							var _v10 = $author$project$Pages$Upload$init(session);
							var uploadMdl = _v10.a;
							var uploadMsg = _v10.b;
							return _Utils_Tuple2(
								$author$project$Main$Upload(uploadMdl),
								A2($elm$core$Platform$Cmd$map, $author$project$Main$GotUploadMsg, uploadMsg));
						} else {
							break _v0$7;
						}
					case 'Logout':
...
var $author$project$Route$Reload = {$: 'Reload'};
var $author$project$Route$Tacview = {$: 'Tacview'};
...
var $author$project$Route$parser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$Reload,
			$elm$url$Url$Parser$s('reload')),
			A2(
			$elm$url$Url$Parser$map,
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$Tacview,
			$elm$url$Url$Parser$s('tacview'))
		]));
...
var $author$project$Session$fromUser = F2(
	function (key, maybeUser) {
		if (maybeUser.$ === 'Just') {
			var userVal = maybeUser.a;
			return A2($author$project$Session$LoggedIn, key, userVal);
		} else {
...
var $author$project$Session$user = function (session) {
	if (session.$ === 'Guest') {
		...
		var userVal = session.b;
		return $elm$core$Maybe$Just(userVal);
	}
};
var $author$project$Main$init = F3(
	function (maybeUser, url, nav) {
		var _v0 = A2(
			$author$project$Main$changeRouteTo,
			$author$project$Route$fromUrl(url),
			$author$project$Main$Redirect(
				A2($author$project$Session$fromUser, nav, maybeUser)));
		var mdl = _v0.a;
		var msg = _v0.b;
		var userMsg = A2(
			...
			A2(
				...
				function (user) {
					return A4(
						...
						$author$project$Main$GotUserResult,
						$elm$json$Json$Decode$succeed(_Utils_Tuple0));
				},
				$author$project$Session$user(
					$author$project$Main$toSession(mdl))));
		return _Utils_Tuple2(
			mdl,
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
...
var $author$project$Session$changes = F2(
	function (toMsg, key) {
		return A2(
			$author$project$Api$userChanges,
			function (maybeUser) {
				return toMsg(
					A2($author$project$Session$fromUser, key, maybeUser));
			},
			$author$project$User$tokenDecoder);
	});
var $elm$core$Platform$Sub$map = _Platform_map;
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Pages$Login$GotSession = function (a) {
	return {$: 'GotSession', a: a};
};
var $author$project$Pages$Login$subscriptions = function (model) {
	return A2(
		$author$project$Session$changes,
		$author$project$Pages$Login$GotSession,
	...
	switch (model.$) {
		...
		case 'Login':
			...
			return A2(
				...
				$author$project$Pages$Login$subscriptions(loginMdl));
		default:
			var uploadMdl = model.a;
			return A2(
				$elm$core$Platform$Sub$map,
				$author$project$Main$GotUploadMsg,
				$author$project$Pages$Upload$subscriptions(uploadMdl));
	}
};
...
var $author$project$Pages$Login$CompletedLogin = function (a) {
...
var $author$project$Session$encodeLoginBody = function (loginBody) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'username',
				$elm$json$Json$Encode$string(loginBody.username)),
				_Utils_Tuple2(
				'password',
				$elm$json$Json$Encode$string(loginBody.password))
			]));
};
...
var $author$project$Session$login = F2(
	function (loginBody, msg) {
		return A4(
			$author$project$Api$post,
			$author$project$Api$Endpoint$login,
			msg,
			$elm$http$Http$jsonBody(
				$author$project$Session$encodeLoginBody(loginBody)),
			$author$project$User$tokenDecoder);
	});
var $author$project$Api$storeUserWith = F2(
	function (user, encoder) {
		var json = encoder(user);
		return $author$project$Api$storeCache(
			$elm$core$Maybe$Just(json));
	});
var $author$project$User$userEncoder = function (userVal) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'token',
				$elm$json$Json$Encode$string(userVal.token))
			]));
};
var $author$project$Session$store = function (userVal) {
	return A2($author$project$Api$storeUserWith, userVal, $author$project$User$userEncoder);
};
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'LoginSubmitted':
				return _Utils_Tuple2(
					model,
					A2($author$project$Session$login, model, $author$project$Pages$Login$CompletedLogin));
			case 'CompletedLogin':
				var result = msg.a;
				if (result.$ === 'Err') {
					var e = result.a;
					var er = A2($elm$core$Debug$log, 'Error ', e);
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				} else {
					var token = result.a;
					return _Utils_Tuple2(
						...
						$author$project$Session$store(
							A2($elm$core$Debug$log, 'Token value ', token)));
				}
			default:
				var session = msg.a;
				return _Utils_Tuple2(
...
var $author$project$Pages$Upload$LoadError = function (a) {
			...
			function (response) {
				switch (response.$) {
					...
					case 'BadStatus_':
						...
						return $elm$core$Result$Err(
							$elm$http$Http$BadBody(
								'BadStatus ' + ($elm$core$String$fromInt(metadata.statusCode) + (': ' + body))));
					default:
						var metadata = response.a;
						var body = response.b;
			...
			case 'UpdateFile':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							file: $author$project$Pages$Upload$Selected(file)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ClickedSelectFile':
				return _Utils_Tuple2(
					model,
					A2($elm$file$File$Select$file, _List_Nil, $author$project$Pages$Upload$UpdateFile));
			case 'ClickedUpload':
				var file = msg.a;
				return _Utils_Tuple2(
					model,
					A5(
						...
						$author$project$Api$Endpoint$upload,
						$author$project$Pages$Upload$GotUploadResult,
						...
						$elm$json$Json$Decode$succeed(_Utils_Tuple0)));
			case 'GotUploadResult':
				var result = msg.a;
				if (result.$ === 'Ok') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{file: $author$project$Pages$Upload$Success}),
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								file: $author$project$Pages$Upload$Error(
									$author$project$Util$errToString(err))
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'GotMissionResult':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var list = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								missions: $author$project$Pages$Upload$Loaded(list)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var err = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								missions: $author$project$Pages$Upload$LoadError(
									$author$project$Util$errToString(err))
							}),
						$elm$core$Platform$Cmd$none);
				}
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								tacViews: $author$project$Pages$Upload$Loaded(list)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var err = result.a;
		...
		while (true) {
			switch (_v0.a.$) {
				...
				case 'GotLoginMsg':
					if (_v0.b.$ === 'Login') {
						var subMsg = _v0.a.a;
						var loginMdl = _v0.b.a;
						return A3(
							$author$project$Util$updateWith,
							$author$project$Main$Login,
							$author$project$Main$GotLoginMsg,
							A2($author$project$Pages$Login$update, subMsg, loginMdl));
					} else {
						break _v0$5;
					}
				case 'GotUploadMsg':
					if (_v0.b.$ === 'Upload') {
						var subMsg = _v0.a.a;
						var uploadMdl = _v0.b.a;
						return A3(
							$author$project$Util$updateWith,
							$author$project$Main$Upload,
							$author$project$Main$GotUploadMsg,
							A2($author$project$Pages$Upload$update, subMsg, uploadMdl));
					} else {
						break _v0$5;
					}
				case 'GotUserResult':
					...
					if (result.$ === 'Err') {
						var _v4 = $author$project$Pages$Login$init(
							A2(
								$author$project$Session$fromUser,
								$author$project$Session$navKey(session),
								$elm$core$Maybe$Nothing));
						var lmdl = _v4.a;
						return A2(
							...
							$author$project$Main$Login(lmdl));
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					}
				default:
...
var $author$project$Pages$LoggedOut$view = function (session) {
	return {
		body: _List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('gate')
					]),
				_List_fromArray(
					[
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('You\'ve been logged out of the application.')
											])),
										A2(
										$elm$html$Html$li,
										_List_Nil,
										_List_fromArray(
											[
												$elm$html$Html$text('You may still be logged in to your single sign-on identity provider.')
											]))
									])),
								A2(
								$elm$html$Html$div,
									...
									[
										...
										_List_fromArray(
											[
												...
												$author$project$Route$routeToString($author$project$Route$Reload))
											]),
										_List_fromArray(
											[
...
var $author$project$Pages$Login$LoginSubmitted = {$: 'LoginSubmitted'};
var $author$project$Pages$Login$UpdatePassword = function (a) {
	return {$: 'UpdatePassword', a: a};
};
var $author$project$Pages$Login$UpdateUsername = function (a) {
...
var $author$project$Pages$Login$viewForm = function (_v0) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('dialog'),
				$elm$html$Html$Events$onSubmit($author$project$Pages$Login$LoginSubmitted)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('form-field-input-container')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$name('login'),
										$elm$html$Html$Attributes$type_('text'),
										$elm$html$Html$Attributes$value(username),
										$elm$html$Html$Events$onInput($author$project$Pages$Login$UpdateUsername),
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$value(password),
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onClick($author$project$Pages$Login$LoginSubmitted)
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Login')
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Pages$Login$viewForm(model)
							]))
					]))
			]),
		title: 'Login'
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href('/api/tacviews/' + tv.filename),
						$elm$html$Html$Attributes$target('new')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(tv.filename)
					]))
			]));
};
...
var $author$project$Main$viewPage = F3(
	function (pageView, mdl, toMsg) {
		var result = pageView(mdl);
		return {
			body: A2(
				$elm$core$List$map,
...
var $author$project$Main$view = function (model) {
	switch (model.$) {
		...
		case 'Logout':
			var session = model.a;
			return $author$project$Pages$LoggedOut$view(session);
		case 'Login':
			var mdl = model.a;
			return A3($author$project$Main$viewPage, $author$project$Pages$Login$view, mdl, $author$project$Main$GotLoginMsg);
		case 'Redirect':
			var session = model.a;
			return $author$project$Pages$Blank$view;
		default:
			var mdl = model.a;
			return A3($author$project$Main$viewPage, $author$project$Pages$Upload$view, mdl, $author$project$Main$GotUploadMsg);
	}
};
